...
const ICONS: Record<string, React.ReactNode> = {
  ...
  telegram: <svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12.056 0h-.112zM5.8 12.8l1.8-6.8 10.4 5.4-10.4 5.4-4.8-2.4c-.4-.2-.4-.8 0-1l.8-.4zm.6 1.2l2.6 1.3-2.6 1.3v-2.6zm6.8 3.4l-2.6-1.3 2.6-1.3 2.6 1.3-2.6 1.3zm-1-2.6l-5.4-2.8 8.4-4.2-8.4 4.2z" fill="white"/></svg>,
...
export function SocialLink({ platform, url, className = "size-8" }: { platform: string; url: string; className?: string }) {
  ...
  return (
    <a
      ...
      className={`${className} flex items-center justify-center rounded-lg text-white transition hover:scale-110`}
      style={{ backgroundColor: info.color }}
      title={info.label}
    >
      {ICONS[platform] || <span className="text-xs">?</span>}
